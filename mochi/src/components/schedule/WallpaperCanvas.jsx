...
const WallpaperCanvas = forwardRef(function WallpaperCanvas({ items = [], section }, ref) {
    ...
    >
      ...
      <div style={{ marginBottom: '24px' }}>
        <div style={{
          ...
          textTransform: 'uppercase', color: pal.headerText, opacity: 0.55, marginBottom: '6px',
        }}>
          Mochi · Schedule
        </div>
        <div style={{
          fontFamily: 'Georgia, "Times New Roman", serif',
          fontSize: '30px', fontWeight: '800', color: pal.headerText, lineHeight: 1.1,
        }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                {byDay[day].map((item, i) => (
                  <div key={i} style={{
                    ...
                    {item.time && (
                      <div style={{ fontSize: '9px', color: '#999', marginBottom: '4px', fontWeight: '600' }}>
                        {item.time}
                      </div>
                    )}
                    <div style={{
                      fontSize: '11px', fontWeight: '800', color: '#2D2030',
